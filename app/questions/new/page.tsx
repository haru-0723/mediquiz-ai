    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
        <div className="bg-white rounded-2xl border p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">問題を追加しました！</h2>
          <div className="flex gap-3 mt-6">
            ...
            <Link href="/questions" className="flex-1 bg-green-600 text-white rounded-xl py-3 text-sm font-medium text-center">
              問題一覧へ
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-xl mx-auto p-8">
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">問題を追加</h1>
        <p className="text-gray-500 text-sm mb-8">4択問題を手動で作成できます。</p>
