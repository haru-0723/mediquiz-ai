      ...
      <div className="max-w-2xl mx-auto px-8 py-12">
        ...
        <div className="space-y-8 text-gray-600 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">買い切り制のため自動更新（自動課金）はありません。購入した期間が満了すると自動的に無料プランに戻ります。期間途中での解約・日割り返金は行いません。ただし、サービスの重大な不具合等、運営者の責に帰すべき事由による場合はこの限りではありません。</p>
            <p className="mt-3">決済にはStripe, Inc.のサービスを利用しています。お支払いはクレジットカードまたはPayPayをご利用いただけます。クレジットカード情報は運営者のサーバーには保存されず、Stripeが安全に管理します。</p>
          </section>
