    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-2">メールを送信しました</h2>
          <p className="text-sm text-slate-500 mb-6">{email} にパスワードリセット用のリンクを送りました。メールを確認してください。</p>
          <Link href="/auth/login" className="text-sm text-emerald-600 hover:underline">ログインページへ戻る</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">登録したメールアドレスを入力してください</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          <Link href="/auth/login" className="text-emerald-600 hover:underline">ログインページへ戻る</Link>
        </p>
      </div>
    </div>
  );
